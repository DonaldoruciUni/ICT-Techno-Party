...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,ticket) values('$fname','$lname','$email','$password','$contact','$ticket')");
...
<div class="form-group">
                  <select id="ticket" name="ticket" class="form-control" required>
                    ...
                    <option value="PREMIUM">Exclusive Access</option>
                  </select>
                </div>
</div>
